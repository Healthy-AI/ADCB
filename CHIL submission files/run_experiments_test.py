...
pehes_seq_cov_dict, ATEs_seq_cov_dict = {k: []
                                         for k in range(8)}, {k: [] for k in range(8)}
...
for num_repetition in range(config.num_repetitions):
    ...
    print("ATEs: ", S_ATEs)
    print("ATEs_Santiago: ", S_ATEs_random)
    ...
    print("Gtruth ATEs: ", gtruth_effect_means)
    print("ATEs: ", T_ATEs)
    print("ATEs_Santiago: ", T_ATEs_random)
    ...
    print("Gtruth ATEs: ", gtruth_effect_means)
    print("ATEs: ", IPW_ATEs)
    print("ATEs_Santiago: ", IPW_ATEs_random)
    ...
    print("PEHEs: ", T_pehes)
    print("PEHEs_Santiago: ", T_pehes_random)
    ...
    print("PEHEs: ", S_pehes)
    print("PEHEs_Santiago: ", S_pehes_random)

    pehes_seq_cov, ATEs_seq_cov = sl.seq_ATE_PEHE(
        RIDs_test, history, gen_df_DX_Based_test, month, "DX", N, epsilon, gamma_0, gamma_1)
    #pehes_seq_random, ATEs_seq_random = sl.seq_ATE_PEHE(RIDs_test, history, gen_df_Santiago_Based_test, month, "Santiago", N, epsilon, gamma_0, gamma_1)
...
with open(config.plotting_pickle_prefix + 'test_epsilon_' + str(epsilon) + '.pickle', 'wb') as f:
