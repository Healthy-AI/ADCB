...
class DataLoader:
    ...
    def loadData(self, ADNIFilepath, DGPcols):
        ...
        UPENNMSMSABETA2 = pd.read_csv(
            '../data/ABETA_files/UPENNMSMSABETA2.csv')
        UPENNMSMSABETA2 = UPENNMSMSABETA2[[
            'RID', 'VISCODE2', 'VID', 'ABETA42', 'ABETA40', 'ABETA38']]

        ADNI_MESOSCALE = pd.read_csv('../data/ABETA_files/ADNI_MESOSCALE.csv')
        ...
        UPENNMSMSABETA = pd.read_csv('../data/ABETA_files/UPENNMSMSABETA.csv')
        ...
        FUJIREBIOABETA = pd.read_csv('../data/ABETA_files/FUJIREBIOABETA.csv')
