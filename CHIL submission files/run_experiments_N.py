...
def main(N=10000):
    ...
    if(bool_train):
        ...
        _ = sl.train(month, gen_df_Santiago_Based_train, history, gen_df_Santiago_Based_test,
    ...
    with open(config.plotting_pickle_prefix + 'N_' + str(N) + '.pickle', 'wb') as f:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='run experiments N')
